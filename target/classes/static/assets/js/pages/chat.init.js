...
!function () {
    var r = "assets/images/users/user-dummy-img.jpg", n = "assets/images/users/multi-user.jpg", o = !1;
    ...
    function t(e) {
        ...
        e = e, t = function (e, t) {
            var a, r, s, n, l, i;
            null !== e ? console.log("Something went wrong: " + e) : (a = "users" == c ? t[0].chats : t[0].channel_chat, document.getElementById(c + "-conversation").innerHTML = "", r = 0, a.forEach(function (t, e) {
                var s, n;
                0 < r ? r -= 1 : (n = t.from_id == m ? " right" : " left", s = d.find(function (e) {
                    return e.id == t.to_id
                }), n = '<li class="chat-list' + n + '" id=' + t.id + '>                        <div class="conversation-list">', m != t.from_id && (n += '<div class="chat-avatar"><img src="' + s.profile + '" alt=""></div>'), n = (n += '<div class="user-chat-content">') + u(t.id, t.msg, t.has_images, t.has_files, t.has_dropDown), a[e + 1] && t.from_id == a[e + 1].from_id && (r = function (e, t, s) {
                    for (var n = 0; e[t] && e[t + 1] && e[t + 1].from_id == s;) n++, t++;
                    return n
                }(a, e, t.from_id), n += function (e, t, s) {
                    for (var n = 0; e[t] && e[t + 1] && e[t + 1].from_id == s;) n = u(e[t + 1].id, e[t + 1].msg, e[t + 1].has_images, e[t + 1].has_files, e[t + 1].has_dropDown), t++;
                    return n
                }(a, e, t.from_id)), n = n + ('<div class="conversation-name"><span class="d-none name">' + s.name + '</span><small class="text-muted time">' + t.datetime) + '</small> <span class="text-success check-message-icon"><i class="bx bx-check-double"></i></span></div></div>                </div>            </li>', document.getElementById(c + "-conversation").innerHTML += n)
            ...
            }), S(), w(), e = b.querySelectorAll(".reply-message"), s = document.querySelector(".replyCard"), n = document.querySelector("#close_toggle"), e.forEach(function (t) {
                t.addEventListener("click", function () {
                    o = !0, s.classList.add("show"), n.addEventListener("click", function () {
            ...
            }), t = E.querySelectorAll(".reply-message"), l = document.querySelector(".replyCard"), i = document.querySelector("#close_toggle"), t.forEach(function (t) {
                t.addEventListener("click", function () {
                    o = !0, l.classList.add("show"), i.addEventListener("click", function () {
            ...
            }), v("users-chat"), GLightbox({selector: ".popup-img", title: !1})
        }, (s = new XMLHttpRequest).open("GET", e, !0), s.responseType = "json", s.onload = function () {
            var e = s.status;
    ...
    e("chat-users-list.json", function (e, t) {
        null !== e ? console.log("Something went wrong: " + e) : (t[0].users.forEach(function (e, t) {
            var s = e.profile ? '<img src="' + e.profile + '" class="rounded-circle img-fluid userprofile" alt=""><span class="user-status"></span>' : '<div class="avatar-title rounded-circle bg-primary text-white fs-10">' + e.nickname + '</div><span class="user-status"></span>',
                ...
                r = 1 === e.id ? "active" : "";
            document.getElementById("userList").innerHTML += '<li id="contact-id-' + e.id + '" data-name="direct-message" class="' + r + '">                ' + a + '                 <div class="d-flex align-items-center">                    <div class="flex-shrink-0 chat-user-img ' + e.status + ' align-self-center me-2 ms-0">                        <div class="avatar-xxs">                        ' + s + '                        </div>                    </div>                    <div class="flex-grow-1 overflow-hidden">                        <p class="text-truncate mb-0">' + e.name + "</p>                    </div>                    " + n + "                </div>            </a>        </li>"
            ...
            document.getElementById("channelList").innerHTML += '<li id="contact-id-' + e.id + '" data-name="channel">            ' + n + '                 <div class="d-flex align-items-center">                    <div class="flex-shrink-0 chat-user-img align-self-center me-2 ms-0">                        <div class="avatar-xxs">                            <div class="avatar-title bg-light rounded-circle text-body">#</div>                        </div>                    </div>                    <div class="flex-grow-1 overflow-hidden">                        <p class="text-truncate mb-0">' + e.name + "</p>                    </div>                    <div>" + s + "</div>                    </div>            </a>        </li>"
        })), s(), document.querySelectorAll("#userList li").forEach(function (n) {
            n.addEventListener("click", function () {
                c = "users", p(), a = "users-chat";
                var t, e = n.getAttribute("id"), s = n.querySelector(".text-truncate").innerHTML;
                document.querySelector(".user-chat-topbar .text-truncate .username").innerHTML = s, document.querySelector(".profile-offcanvas .username").innerHTML = s, 1 == o && (o = !1, document.querySelector(".replyCard").classList.remove("show")), document.getElementById(e).querySelector(".userprofile") ? (t = document.getElementById(e).querySelector(".userprofile").getAttribute("src"), document.querySelector(".user-chat-topbar .avatar-xs").setAttribute("src", t), document.querySelector(".profile-offcanvas .avatar-lg").setAttribute("src", t)) : (document.querySelector(".user-chat-topbar .avatar-xs").setAttribute("src", r), document.querySelector(".profile-offcanvas .avatar-lg").setAttribute("src", r)), document.getElementById("users-conversation").querySelectorAll(".left .chat-avatar").forEach(function (e) {
            ...
            s.addEventListener("click", function () {
                ...
                var e = s.querySelector(".text-truncate").innerHTML, t = document.getElementById("channel-chat");
                t.querySelector(".user-chat-topbar .text-truncate .username").innerHTML = e, document.querySelector(".profile-offcanvas .username").innerHTML = e, t.querySelector(".user-chat-topbar .avatar-xs").setAttribute("src", n), document.querySelector(".profile-offcanvas .avatar-lg").setAttribute("src", n), 1 == o && (o = !1, document.querySelector(".replyCard").classList.remove("show"))
            })
        })
    }), e("chat-contacts-list.json", function (e, t) {
        var n, a;
        null !== e ? console.log("Something went wrong: " + e) : ((d = t).sort(function (e, t) {
            return e.name.localeCompare(t.name)
        }), a = n = "", d.forEach(function (e, t) {
            var s = e.profile ? '<img src="' + e.profile + '" class="img-fluid rounded-circle" alt="">' : '<span class="avatar-title rounded-circle bg-primary fs-10">' + e.nickname + "</span>",
                s = (n = '<li>              <div class="d-flex align-items-center">                  <div class="flex-shrink-0 me-2">                      <div class="avatar-xxs">                          ' + s + '                      </div>                  </div>                  <div class="flex-grow-1">                  <p class="text-truncate contactlist-name mb-0">' + e.name + '</p>                  </div>                  <div class="flex-shrink-0">                      <div class="dropdown">                          <a href="#" class="text-muted" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                              <i class="ri-more-2-fill"></i>                          </a>                          <div class="dropdown-menu dropdown-menu-end">                              <a class="dropdown-item" href="#"><i class="ri-pencil-line text-muted me-2 align-bottom"></i>Edit</a>                              <a class="dropdown-item" href="#"><i class="ri-forbid-2-line text-muted me-2 align-bottom"></i>Block</a>                              <a class="dropdown-item" href="#"><i class="ri-delete-bin-6-line text-muted me-2 align-bottom"></i>Remove</a>                          </div>                      </div>                  </div>              </div>          </li>', '<div class="mt-3" >              <div class="contact-list-title">' + e.name.charAt(0).toUpperCase() + '                </div>          <ul id="contact-sort-' + e.name.charAt(0) + '" class="list-unstyled contact-list" >');
            a != e.name.charAt(0) && (document.getElementsByClassName("sort-contact")[0].innerHTML += s), document.getElementById("contact-sort-" + e.name.charAt(0)).innerHTML = document.getElementById("contact-sort-" + e.name.charAt(0)).innerHTML + n, a = e.name.charAt(0)
        })), document.querySelectorAll(".sort-contact ul li").forEach(function (n) {
            n.addEventListener("click", function (e) {
                c = "users", p();
                var t, s = n.querySelector("li .contactlist-name").innerHTML;
                document.querySelector(".user-chat-topbar .text-truncate .username").innerHTML = s, document.querySelector(".profile-offcanvas .username").innerHTML = s, 1 == o && (o = !1, document.querySelector(".replyCard").classList.remove("show")), n.querySelector(".align-items-center").querySelector(".avatar-xxs img") ? (t = n.querySelector(".align-items-center").querySelector(".avatar-xxs .rounded-circle").getAttribute("src"), document.querySelector(".user-own-img .avatar-xs").setAttribute("src", t), document.querySelector(".profile-offcanvas .profile-img").setAttribute("src", t)) : (document.querySelector(".user-own-img .avatar-xs").setAttribute("src", r), document.querySelector(".profile-offcanvas .profile-img").setAttribute("src", r)), document.getElementById("users-conversation").querySelectorAll(".left .chat-avatar").forEach(function (e) {
                    t ? e.querySelector("img").setAttribute("src", t) : e.querySelector("img").setAttribute("src", r)
                }), window.stop()
            })
        }), s()
    }), p();
    var f = document.querySelector("#chatinput-form"), g = document.querySelector("#chat-input"),
    ...
    f && f.addEventListener("submit", function (e) {
        e.preventDefault();
        var e = a, t = a, s = g.value;
        0 === s.length ? (h.classList.add("show"), setTimeout(function () {
            h.classList.remove("show")
        }, 2e3)) : (1 == o ? (k(t, s), o = !1) : q(e, s), v(e || t)), g.value = "", document.getElementById("close_toggle").click()
    });
    ...
    var q = function (e, t) {
        ...
        var s = document.getElementById(e).querySelector(".chat-conversation-list"),
            n = (null != t && s.insertAdjacentHTML("beforeend", '<li class="chat-list right" id="chat-list-' + x + '" >                <div class="conversation-list">                    <div class="user-chat-content">                        <div class="ctext-wrap">                            <div class="ctext-wrap-content">                                <p class="mb-0 ctext-content">                                    ' + t + '                                </p>                            </div>                            <div class="dropdown align-self-start message-box-drop">                                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                                    <i class="ri-more-2-fill"></i>                                </a>                                <div class="dropdown-menu">                                    <a class="dropdown-item reply-message" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply</a>                                    <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>                                    <a class="dropdown-item copy-message" href="#""><i class="ri-file-copy-line me-2 text-muted align-bottom"></i>Copy</a>                                    <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark</a>                                    <a class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete</a>                            </div>                        </div>                    </div>                    <div class="conversation-name">                        <small class="text-muted time">' + y() + '</small>                        <span class="text-success check-message-icon"><i class="bx bx-check"></i></span>                    </div>                </div>            </div>        </li>'), document.getElementById("chat-list-" + x));
        n.querySelectorAll(".delete-item").forEach(function (e) {
            ...
            a.addEventListener("click", function () {
                var e = document.querySelector(".replyCard"), t = document.querySelector("#close_toggle"),
                    ...
                    t = (o = !0, e.classList.add("show"), t.addEventListener("click", function () {
